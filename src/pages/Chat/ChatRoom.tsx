...
export const ChatRoom: React.FC = () => {
  ...
  const { isTyping, getTypingText, emitStopTyping, resetTypingState } =
    useTyping({
  ...
  return (
    <div id="chat-room" className="flex flex-col h-full overflow-hidden">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={() => {
                dispatch(
                  setCurrentChat({
                    chat: undefined as unknown as ChatListItemInterface,
                  }),
                );
                navigate("/chat");
              }}
      ...
      <div
        id="messages"
        className="relative left-0 lg:w-full right-0 gap-6 h-screen flex flex-col flex-grow overflow-y-auto overflow-x-hidden mt-16 transition-all duration-200 chat-background"
      >
        <div
          ref={(e) => {
            if (e) {
