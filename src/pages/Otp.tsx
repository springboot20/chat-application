...
// import { IS_DIGIT_REG } from '../utils/constants';
...
export const Otp = () => {
  ...
  const onChange = (values: string[]) => setOTP(values);
  ...
  const handleChange = (value: string, index: number) => {
    const isTargetValue = Number(value);
    ...
    if (value !== '' && index < length - 1 && isTargetValue) {
  ...
  //     const previousElementSibling = event.target as HTMLInputElement;
