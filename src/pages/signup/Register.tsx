    ...
    <div className='flex flex-col justify-center items-center min-h-screen p-3'>
      ...
      <div className='mt-10 w-full bg-white dark:bg-white/5 rounded-lg p-4 sm:p-6 md:max-w-xl'>
        <form onSubmit={handleSubmit}>
          ...
          <fieldset className='mt-3'>
            ...
            <div className='mt-2 relative'>
              ...
              <button
                ...
                {show ? (
                  <EyeSlashIcon
                    className='h-6 w-6 cursor-pointer text-gray-700 dark:text-white/70'
                    strokeWidth={2}
                  />
                ) : (
                  <EyeIcon
                    className='h-6 w-6 cursor-pointer text-gray-500 dark:text-white/50'
                    strokeWidth={2}
                  />
                )}
              </button>
          ...
          <Button
            type='submit'
            disabled={isLoading || !value.username || !value.email || !value.password}
            className='flex items-center justify-center w-full mt-5 bg-indigo-500 text-white font-semibold rounded-md transition disabled:opacity-70'>
            {isLoading ? (
