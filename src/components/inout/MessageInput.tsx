...
interface MessageInputProps {
  ...
  user: User;
  // ❌ REMOVED: socket prop - typing logic moved to Chat.tsx
}
...
const MessageInput = ({
  ...
  // ✅ SIMPLIFIED: Send message handler (no typing logic)
  ...
  // ✅ SIMPLIFIED: Input change handler (no typing logic)
    ...
    <div
      ...
      <div className='flex items-end justify-between mx-auto max-w-8xl relative z-20 px-2 py-2 gap-2'>
        ...
        <textarea
          ...
          className={classNames(
            'w-full p-3 resize-none focus:outline-none rounded-lg border dark:border-white/5 outline-none',
        ...
        <button
          ...
          className={classNames(
            ...
            canSend
              ? 'bg-indigo-500 hover:bg-indigo-600 dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:text-white cursor-pointer'
