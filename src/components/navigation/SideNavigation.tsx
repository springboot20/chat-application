  ...
  links: [
    {
      ...
      icon: (
        <svg
          ...
          className="h-10 stroke-gray-500 fill-none stroke-2 transition cursor-pointer hover:stroke-[#615EF0] dark:stroke-white dark:hover:stroke-[#615EF0]"
        >
          <path
...
const SideNavigation = ({ open }: PanelProps) => {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 min-h-screen shadow-sm border-r-[1.5px] border-r-gray-600/30 bottom-0 bg-white dark:bg-gray-800 w-32`}
    >
      <div
            ...
            <div className="flex items-center">
              <span className="inline-flex items-center">
                <svg
                  ...
                  viewBox="0 0 56 56"
                  xmlns="http://www.w3.org/2000/svg"
                  className="fill-[#615EF0] h-20 w-20"
                >
